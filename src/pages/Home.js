        ...
        <form noValidate onSubmit={handleFormSubmit} onReset={handleFormReset}>
          <Grid2 container spacing={2} alignItems="center" justifyContent="center" sx={{ mb: 2 }}>
            ...
            <Grid2 size={{ xs: 12, sm: 4 }}>
              ...
              fullWidth size='small'
              required
              error={missingFields.includes('State')}
              >
            ...
            <Grid2 size={{ xs: 12, sm: 4 }}>
              <TextField
              required
              error={missingFields.includes('Temp_Min')}
            ...
            <Grid2 size={{ xs: 12, sm: 4 }}>
              <TextField
              required
              error={missingFields.includes('Temp_Max')}
            ...
            <Grid2 size={{ xs: 12, sm: 4 }}>
              <TextField
              required
              error={missingFields.includes('Rain_mm')}
              label="Rainfall (mm)"
              type="number"
              fullWidth
              name="Rain_mm"
            ...
            <Grid2 size={{ xs: 12, sm: 4 }}>
              <TextField
              required
              error={missingFields.includes('Evaporation_mm')}
